...
def compute_attribution_saliency_maps_intergrated(text_char,
  ...
  interpolated_char_inputs = interpolate_inputs(baseline_char_emb, text_char_emb, 1)
  interpolated_word_inputs = interpolate_inputs(baseline_word_emb, text_word_emb, 1)
